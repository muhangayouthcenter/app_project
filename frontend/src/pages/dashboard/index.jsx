...
export default function Dashboard() {
  ...
  const [recordSortBy, setRecordSortBy] = useState("created_at")
          ...
          <div className="dashboard-input-header">
            <div className="search-container">
              ...
              <input
                ...
                placeholder={`Search in ${activeRecordBook?.name || ''}`}
            ...
            {/* Filter Panel */}
            {showFilterPanel && activeRecordBook && (
              <div className="filter-panel">
                <div className="filter-panel-header">
                  <h4>Filter & Sort: {activeRecordBook?.name || ''}</h4>
                  <button
                ...
                <div className="filter-controls">
                  <div className="filter-row">
                    ...
                    <div className="filter-group">
                      ...
                      >
                        ...
                        {activeRecordBook.attributes?.map(attr => (
                          <option key={attr.field_name} value={attr.field_name}>
                            {attr.field_name}
                          </option>
                        ))}
                      </select>
                    ...
                    <div className="filter-group">
                      ...
                      <input
                        ...
                        max="200"
                        value={recordLimit}
                        onChange={(e) => setRecordLimit(Number(e.target.value) || 20)}
                  ...
                  <div className="filter-actions">
                    {recordSearchTerm && (
                      <button
                        className="btn-mac btn-mac-secondary-mac"
                    ...
                    <button
                      className="btn-mac btn-mac-primary-mac"
                      onClick={() => setShowFilterPanel(false)}
                    >
                      Done
                    </button>
